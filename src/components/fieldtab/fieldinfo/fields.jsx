    ...
    <>
      <div className="h-full lg:row-start-1 lg:row-span-3 lg:col-start-5 lg:col-span-2 flex flex-col gap-2 lg:mb-0 mb-5 rounded-md text-white">
        <div className="rounded-xl bg-[#181f26] border-2 border-[#45484a] lg:h-[45%] h-[200px]">
          <div className="h-[20%] text-sm bg-[#323d49] rounded-t-xl flex items-center px-2 justify-between gap-2">
            ...
            <div className="flex bg-[#212930] rounded-md border-2 border-[#45484a] mb-1.5">
              ...
              <div className="flex flex-col w-full py-1 gap-1 px-1.5">
                ...
                <div className="flex justify-between gap-2 items-end">
                  <p className="line-clamp-1 font-semibold text-sm text-[#8eb0d3]">
                    Industrial Crop
                  </p>
        ...
        {/* <ScrollArea
          className={
            "lg:h-[250px] h-[150px] bg-[#181f26] rounded-md flex flex-col p-1.5"
          }
        >
          <div className="flex bg-[#212930] rounded-md border-2 border-[#3cc1f2]">
            ...
            <div className="flex flex-col w-full py-1 gap-0.5 px-1.5">
              <div className="flex justify-between gap-1.5">
                <p className="line-clamp-1 text-sm xl:w-[100px] w-[55px] text-start">
                  Field-1 as adasds adsad asad asdasdsa dff asdasd adasd
                </p>
                <p className="line-clamp-1 text-sm text-end">
                  Lat | Lon: -93.1, -22.2
                </p>
              </div>
              <p className="line-clamp-1 font-semibold">Industrial Crop</p>
            </div>
          </div>
          <div className="flex bg-[#212930] rounded-md border-2 border-[#3cc1f2]">
            <div className="w-[60px]">
        ...
        <ScrollArea
          className={"w-full lg:h-full h-[210px] p-1.5 bg-[#181f26] rounded-xl"}
        >
          <p className="font-medium mb-1.5 px-1">Field-1</p>
          <div className="grid grid-cols-2 gap-1.5">
            <div className="bg-[#212930] p-1 rounded-md border-2 border-[#45484a]">
              <p className="text-sm line-clamp-1 text-[#8eb0d3]">Crop Type</p>
              <p className="text-sm line-clamp-1">Industrial Crop</p>
